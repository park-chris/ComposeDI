...
import com.crystal.face_recognition.recognition.FaceAnalyzer
import com.crystal.face_recognition.recognition.FaceAnalyzerListener
...
class Camera(private val context: Context) : ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private val cameraSelector by lazy {
        CameraSelector.Builder()
            .requireLensFacing(CameraSelector.LENS_FACING_FRONT) // 카메라 렌즈 전면 렌즈 사용
            .build()
    }
